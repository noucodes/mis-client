...
export const columns: ColumnDef<Applicant>[] = [
    ...
    },
    {
        ...
        header: "Applicant Created",
        cell: ({ row }) => {
            const createdDate = row.getValue("applicant_created") as string;
    ...
    },
    {
        ...
        header: "Position Applied", // Fixed typo: "Position Given" to "Position Applied"
    },
    {
